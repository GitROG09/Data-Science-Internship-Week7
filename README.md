...
│   ├── ttest_analysis.ipynb
│   ├── correlation_analysis.ipynb
│   └── confidence_interval.ipynb
│
└── project/
    └── business_statistical_analysis.ipynb


hands_on/ – Contains five notebooks for practicing core statistics concepts.
...
Plotted sales distributions using histograms and density plots.

Performed t-tests to compare sales between groups (e.g., Before vs After campaigns).

Calculated correlations between marketing spend and sales.
...
Tested hypotheses on sales performance.
...
Upload the provided CSV dataset (or use the generated dataset in the notebook).
...
Columns include: Sales, Marketing_Spend, Customer_Count, Discount, Region.
